        ...
        <div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
            <form class="login100-form validate-form flex-sb flex-w">
                ...
                <span class="login100-form-title p-b-30">
                    <br>
						Ora il tuo account è attivo!
					</span>


                <span class="txt1 p-b-3">
                    benvenuto su immobile17
					</span>


                <span class="txt3 p-b-11">
						Ora puoi prenotare il tuo primo appuntamento
                        <br>
                    <br>
                    <br>
                ...
                <div style="position:absolute; top:280px; left:370px; z-index:1">
                    <a href = "{$path}">
                        <span class="txt1 p-b-3">
                        Torna alla Home
                        </span>
